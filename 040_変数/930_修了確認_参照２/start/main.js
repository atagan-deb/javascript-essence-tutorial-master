...
minus(obj, 1);
console.log(obj.prop1); // 9が表示されればOK
/**
 * 問題２：
...
obj = fn(obj);
// prop.prop3 = 2 までが参照先がobjと同じである
// よって、2
// かと思いきや、returnでobj = { prop2 : {prop3: 3}}となるため、3
console.log(obj.prop2.prop3); // return文からボトムアップでコードを追うと間違えにくい
